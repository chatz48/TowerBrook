...
import { Badge, ConfidenceBars, DataPageHeader, DataTable, PageShell } from "@/app/components/ui";
...
export default async function CompaniesPage({
  ...
  const targetRows: TargetCompanyRow[] = actionableTargets.map((company) => ({
    company,
    graph: toEntityGraphModel(graphModel, `company:${company.id}`, themeFocus),
  }));
